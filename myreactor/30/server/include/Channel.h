...
private:
    ...
    const std::unique_ptr<EventLoop>& loop_;           // Channel对应的红黑树，Channel与Epollevent是多对一的关系，一个Channel只对应一个Epollevent。
    //EventLoop *loop_;                                // Channel对应的红黑树，Channel与Epollevent是多对一的关系，一个Channel只对应一个Epollevent。
