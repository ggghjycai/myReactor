...
int main(int argc, char *argv[])
{
  if (argc != 7)
  {
    printf("usage:./echoServer ip port IO_THREAD WORK_THREAD LOOP_TIMEVAL CONNECTION_TIMEOUT\n");
    printf("example:./echoServer 192.168.126.200 5055 3 3 10 5\n\n");
    return -1;
  }
  ...
  echoserver=new EchoServer(argv[1],atoi(argv[2]),atoi(argv[3]),atoi(argv[4]),atoi(argv[5]),atoi(argv[6]));
  echoserver->Start();
}